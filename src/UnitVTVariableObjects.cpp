...
//==============================================================================
//type=21
bool TVTNumberVariable::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
...
//------------------------------------------------------------------------------
bool TVTNumberVariable::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTNumberVariable::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
...
void TVTNumberVariable::setAID()
{
    ...
    VTAttrAID[1].byteAID = 4;
    VTAttrAID[1].typeAID = 0;
    VTAttrAID[1].nameAID = "VTValue";
    VTAttrAID[1].valueAID = QString::number(VTValue);
    VT_AID_Nr = 2;
};

//==============================================================================
//type=22
bool TVTStringVariable::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    bool valid = (getVTObjectListSize(pVT_Net) > 0);
    uint8_t err = 0x00;
    int16_t objIdx = pVT_Net->objNr;
...
//------------------------------------------------------------------------------
bool TVTStringVariable::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTStringVariable::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    bool valid = (pStream->available());
    uint16_t i = 0, j = 0, nn = 0;
    uint8_t bb = 0;
...
void TVTStringVariable::setAID()
{
    ...
    VTAttrAID[1].nameAID = "VTLength";
    VTAttrAID[1].valueAID = VTValue;
    VT_AID_Nr = 2;
};

//==============================================================================
//type=39
bool TVTColourMap::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    bool valid = (getVTObjectListSize(pVT_Net) > 0);
    uint8_t err = 0x00;
    int16_t objIdx = pVT_Net->objNr;
...
//------------------------------------------------------------------------------
bool TVTColourMap::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTColourMap::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    bool valid = (pStream->available());
    uint16_t i = 0, j = 0, nn = 0;
    uint8_t bb = 0;
    ...
    if (valid) {
        ...
        for (i = 1; i < VT_AID_Nr; i++) {
            nn = VTAttrAID[i].valueAID.toInt();
            if (i == 1)
                getVTColourItems(pVT_Net, nn, pStream);
        } //for i
        getVTObjectListAdd(pVT_Net);
        pVT_Net->streamStr.clear();
    } //valid
...
void TVTColourMap::setAID()
{
    ...
    VTAttrAID[1].byteAID = 2;
    VTAttrAID[1].typeAID = 2;
    VTAttrAID[1].nameAID = "VTIndexNumber";
    VTAttrAID[1].valueAID = QString::number(VTIndexNumber);
    VT_AID_Nr = 2;
};

//==============================================================================
//type=45
bool TVTColourPalette::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    bool valid = (getVTObjectListSize(pVT_Net) > 0);
    uint8_t err = 0x00;
    int16_t objIdx = pVT_Net->objNr;
...
//------------------------------------------------------------------------------
bool TVTColourPalette::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTColourPalette::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    bool valid = (pStream->available());
    uint16_t i = 0, j = 0, nn = 0;
    uint8_t bb = 0;
...
void TVTColourPalette::setAID()
{
    ...
    VTAttrAID[2].nameAID = "VTColourItems";
    VTAttrAID[2].valueAID = QString::number(VTColourItems);
    VT_AID_Nr = 3;
};

//==============================================================================
//type=46
bool TVTGraphicData::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    bool valid = (getVTObjectListSize(pVT_Net) > 0);
    uint8_t err = 0x00;
    uint16_t nn = 8;
...
//------------------------------------------------------------------------------
bool TVTGraphicData::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTGraphicData::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    bool valid = (pStream->available());
    uint16_t i = 0;
    uint8_t bb = 0;
...
void TVTGraphicData::setAID()
{
    ...
    VTAttrAID[2].typeAID = 2;
    VTAttrAID[2].nameAID = "VTPicData";
    VTAttrAID[2].valueAID = VTPicData;
    VT_AID_Nr = 3;
}

//==============================================================================
//type=48
bool TVTScaledGraphic::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    bool valid = (getVTObjectListSize(pVT_Net) > 0);
    uint8_t err = 0x00;
...
//------------------------------------------------------------------------------
bool TVTScaledGraphic::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTScaledGraphic::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    bool valid = (pStream->available());
    uint16_t i = 0, j = 0, nn = 0;
    uint8_t bb = 0;
...
void TVTScaledGraphic::setAID()
{
    ...
    VTAttrAID[1].valueAID = VTWidth;
    VTAttrAID[2].numAID = 2;
    VTAttrAID[2].byteAID = 2;
    VTAttrAID[2].typeAID = 1;
    VTAttrAID[2].nameAID = "VTHeight";
    VTAttrAID[2].valueAID = VTHeight;
...
//==============================================================================
//type=48
bool TVTWorkingSetControl::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    bool valid = (getVTObjectListSize(pVT_Net) > 0);
    uint8_t err = 0x00;
    //
...
//------------------------------------------------------------------------------
bool TVTWorkingSetControl::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTWorkingSetControl::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    bool valid = (pStream->available());
    uint16_t i = 0, j = 0, nn = 0;
    uint8_t bb = 0;
...
void TVTWorkingSetControl::setAID()
{
    ...
    VTAttrAID[2].nameAID = "VTColourMap";
    VTAttrAID[2].valueAID = VTColourMap;
    VTAttrAID[3].numAID = 3;
    VTAttrAID[3].byteAID = 2;
    VTAttrAID[3].typeAID = 0;
    VTAttrAID[3].nameAID = "VTColourPalette";
    VTAttrAID[3].valueAID = VTColourPalette;
    VTAttrAID[4].numAID = 4;
    VTAttrAID[4].byteAID = 1;
    VTAttrAID[4].typeAID = 2;
    VTAttrAID[4].nameAID = "VTLanguages";
    VTAttrAID[4].valueAID = VTLanguages;
    VT_AID_Nr = 5;
}
