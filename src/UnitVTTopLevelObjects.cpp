...
//==============================================================================
//==============================================================================
bool TVTWorkingSet::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
...
//------------------------------------------------------------------------------
bool TVTWorkingSet::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTWorkingSet::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    ...
    if (valid) {
        ...
        for (i = 4; i < VT_AID_Nr; i++) {
            ...
            if (i == 6)
                getVTLanguages(pVT_Net, nn, pStream);
        } //for i
        //
...
void TVTWorkingSet::setAID()
{
    ...
    VTAttrAID[2].nameAID = "VTSelectable";
    VTAttrAID[2].valueAID = QString::number(VTSelectable);
    VTAttrAID[3].numAID = 3;
    VTAttrAID[3].byteAID = 2;
    VTAttrAID[3].typeAID = 0;
    VTAttrAID[3].nameAID = "VTActiveMask";
    VTAttrAID[3].valueAID = QString::number(VTActiveMask);
    //
    ...
    VTAttrAID[6].typeAID = 2;
    VTAttrAID[6].nameAID = "VTLanguages";
    VTAttrAID[6].valueAID = VTLanguages;
    VT_AID_Nr = 7;
};

//==============================================================================
//==============================================================================
bool TVTMask::getSoftKeyMask(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    bool valid = true;
...
//------------------------------------------------------------------------------
bool TVTMask::PaintObjToMask(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    bool valid = (getVTObjectListSize(pVT_Net) > 0);
...
//==============================================================================
//==============================================================================
bool TVTDataMask::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    return PaintObjToMask(pViewRect, pVT_Net);
};

//------------------------------------------------------------------------------
bool TVTDataMask::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTDataMask::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    bool valid = (pStream->available());
...
void TVTDataMask::setAID()
{
    ...
    VTAttrAID[2].nameAID = "VTSoftKeyMask";
    VTAttrAID[2].valueAID = QString::number(VTSoftKeyMask);
    //
    VTAttrAID[3].numAID = 3;
...
//==============================================================================
//==============================================================================
bool TVTAlarmMask::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    setAID();
    return PaintObjToMask(pViewRect, pVT_Net);
}
...
//------------------------------------------------------------------------------
bool TVTAlarmMask::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTAlarmMask::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    bool valid = (pStream->available());
    uint16_t i = 0, j = 0, nn = 0;
    uint8_t bb = 0;
...
void TVTAlarmMask::setAID()
{
    ...
    VTAttrAID[3].nameAID = "VTPriority";
    VTAttrAID[3].valueAID = QString::number(VTPriority);
    VTAttrAID[4].numAID = 4;
    VTAttrAID[4].byteAID = 1;
    VTAttrAID[4].typeAID = 1;
    VTAttrAID[4].nameAID = "VTAcousticSignal";
    VTAttrAID[4].valueAID = QString::number(VTAcousticSignal);
    //
    VTAttrAID[5].numAID = 5;
    VTAttrAID[5].byteAID = 1;
    VTAttrAID[5].typeAID = 2;
    VTAttrAID[5].nameAID = "VTObjects";
    VTAttrAID[5].valueAID = VTObjects;
    VTAttrAID[6].numAID = 6;
    VTAttrAID[6].byteAID = 1;
    VTAttrAID[6].typeAID = 2;
    VTAttrAID[6].nameAID = "VTMacros";
    VTAttrAID[6].valueAID = VTMacros;
    VT_AID_Nr = 7;
};

//==============================================================================
//==============================================================================
bool TVTContainer::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    bool valid = (getVTObjectListSize(pVT_Net) > 0);
    uint8_t err = 0x00;
...
//VTObjType=34
//==============================================================================
bool TVTWindowMaskObject::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    bool valid = (getVTObjectListSize(pVT_Net) > 0);
    uint8_t cIdx = 0, err = 0x00;
    uint16_t colTransp = 0/* FIXME TFT_WHITE*/, ww0 = 30, vW, vH, ww, hh, w, h, oLevel = pVT_Net->level;
...
void TVTWindowMaskObject::setAID()
{
    ...
    VTAttrAID[0].nameAID = "VTObjType";
    VTAttrAID[0].valueAID = QString::number(VTObjType);
    VTAttrAID[1].numAID = 4;
    VTAttrAID[1].byteAID = 1;
    VTAttrAID[1].typeAID = 2;
    VTAttrAID[1].nameAID = "VTWidth";
    VTAttrAID[1].valueAID = QString::number(VTWidth);
    VTAttrAID[2].numAID = 5;
    VTAttrAID[2].byteAID = 1;
    ...
    VTAttrAID[3].byteAID = 1;
    VTAttrAID[3].typeAID = 2;
    VTAttrAID[3].nameAID = "VTWindowType";
    VTAttrAID[3].valueAID = QString::number(VTWindowType);
    VTAttrAID[4].numAID = 1;
    VTAttrAID[4].byteAID = 1;
    VTAttrAID[4].typeAID = 1;
    VTAttrAID[4].nameAID = "VTBackgroundColour";
    VTAttrAID[4].valueAID = QString::number(VTBackgroundColour);
    VTAttrAID[5].numAID = 2;
    VTAttrAID[5].byteAID = 1;
    VTAttrAID[5].typeAID = 1;
    VTAttrAID[5].nameAID = "VTOptions";
    VTAttrAID[5].valueAID = QString::number(VTOptions);
    VTAttrAID[6].numAID = 3;
    VTAttrAID[6].byteAID = 2;
    VTAttrAID[6].typeAID = 1;
    VTAttrAID[6].nameAID = "VTName";
    VTAttrAID[6].valueAID = QString::number(VTName);
    VTAttrAID[7].numAID = 7;
    VTAttrAID[7].byteAID = 2;
    VTAttrAID[7].typeAID = 2;
    VTAttrAID[7].nameAID = "VTWindowTitle";
    VTAttrAID[7].valueAID = QString::number(VTWindowTitle);
    VTAttrAID[8].numAID = 8;
    VTAttrAID[8].byteAID = 2;
    VTAttrAID[8].typeAID = 2;
    VTAttrAID[8].nameAID = "VTWindowIcon";
    VTAttrAID[8].valueAID = QString::number(VTWindowIcon);
    //
    VTAttrAID[9].numAID = 9;
    VTAttrAID[9].byteAID = 1;
    VTAttrAID[9].typeAID = 2;
    VTAttrAID[9].nameAID = "VTObjRefs";
    VTAttrAID[9].valueAID = VTObjRefs;
    VTAttrAID[10].numAID = 10;
    VTAttrAID[10].byteAID = 1;
    VTAttrAID[10].typeAID = 2;
    VTAttrAID[10].nameAID = "VTObjects";
    VTAttrAID[10].valueAID = VTObjects;
...
//VTObjType=44
//==============================================================================
bool TVTAnimationObject::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    bool valid = (getVTObjectListSize(pVT_Net) > 0);
    uint8_t cIdx = 0, err = 0x00;
    uint16_t colTransp = 0 /* FIXME TFT_WHITE */, ww0 = 30, vW, vH, ww, hh, w, h, oLevel = pVT_Net->level;
...
//------------------------------------------------------------------------------
bool TVTAnimationObject::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTAnimationObject::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    bool valid = (pStream->available());
    uint16_t i = 0, j = 0, nn = 0;
    uint8_t bb = 0;
...
void TVTAnimationObject::getAID()
{
    ...
    for (i = 1; i < VT_AID_Nr; i++) {
        ...
        case 7:
            ...
            break;
        case 8:
            VTDefaultChildIndex = ww;
            VTEvent += 1;
            break;
        case 9:
            VTAnimationOptions = ww;
            VTEvent += 1;
            break;
        //List
        case 10:
...
void TVTAnimationObject::setAID()
{
    ...
    VTAttrAID[3].byteAID = 2;
    VTAttrAID[3].typeAID = 1;
    VTAttrAID[3].nameAID = "VTRefreshInterval";
    VTAttrAID[3].valueAID = QString::number(VTRefreshInterval);
    VTAttrAID[4].numAID = 4;
    VTAttrAID[4].byteAID = 1;
    VTAttrAID[4].typeAID = 1;
    ...
    VTAttrAID[5].byteAID = 1;
    VTAttrAID[5].typeAID = 1;
    VTAttrAID[5].nameAID = "VTEnabled";
    VTAttrAID[5].valueAID = QString::number(VTEnabled);
    VTAttrAID[6].numAID = 6;
    VTAttrAID[6].byteAID = 1;
    VTAttrAID[6].typeAID = 1;
    VTAttrAID[6].nameAID = "VTFirstChildIndex";
    VTAttrAID[6].valueAID = QString::number(VTFirstChildIndex);
    VTAttrAID[7].numAID = 7;
    VTAttrAID[7].byteAID = 1;
    VTAttrAID[7].typeAID = 1;
    VTAttrAID[7].nameAID = "VTLastChildIndex";
    VTAttrAID[7].valueAID = QString::number(VTLastChildIndex);
    VTAttrAID[8].numAID = 8;
    VTAttrAID[8].byteAID = 1;
    VTAttrAID[8].typeAID = 1;
    VTAttrAID[8].nameAID = "VTDefaultChildIndex";
    VTAttrAID[8].valueAID = QString::number(VTDefaultChildIndex);
    VTAttrAID[9].numAID = 9;
    VTAttrAID[9].byteAID = 1;
    VTAttrAID[9].typeAID = 1;
    VTAttrAID[9].nameAID = "VTAnimationOptions";
    VTAttrAID[9].valueAID = QString::number(VTAnimationOptions);
    //
    VTAttrAID[10].numAID = 10;
    VTAttrAID[10].byteAID = 1;
    VTAttrAID[10].typeAID = 2;
