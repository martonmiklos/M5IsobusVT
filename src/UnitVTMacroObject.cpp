...
//==============================================================================
//type=13
bool TVTMacroObject::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
    bool valid = (getVTObjectListSize(pVT_Net) > 0);
    uint16_t color = 0 /* TFT_BLACK FIXME */, w = 0, h = 0;
    uint8_t err = 0x00;
...
//------------------------------------------------------------------------------
bool TVTMacroObject::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTMacroObject::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
...
void TVTMacroObject::setAID()
{
    ...
    VTAttrAID[1].nameAID = "VTCommands";
    VTAttrAID[1].valueAID = QString::number(VTCommands);
    VT_AID_Nr = 2;
}
