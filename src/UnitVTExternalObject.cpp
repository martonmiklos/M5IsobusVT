...
//==============================================================================
//type=41 and 42
bool TVTExternalObject::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
...
//------------------------------------------------------------------------------
bool TVTExternalObject::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTExternalObject::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
...
void TVTExternalObject::setAID()
{
    ...
    VTAttrAID[2].nameAID = "VTName0";
    VTAttrAID[2].valueAID = QString::number(VTName0);
    VTAttrAID[3].numAID = 3;
    VTAttrAID[3].byteAID = 4;
    VTAttrAID[3].typeAID = 1;
    VTAttrAID[3].nameAID = "VTName1";
    VTAttrAID[3].valueAID = QString::number(VTName1);
    VT_AID_Nr = 4;
    //
    if (VTObjType == 41) {
...
//==============================================================================
//type=43
bool TVTExternalObjectPointer::PaintObjTo(TVT_ViewRect *pViewRect, TVT_Net *pVT_Net)
{
...
//------------------------------------------------------------------------------
bool TVTExternalObjectPointer::writeToStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    return writeToStreamDirect(pVT_Net, pStream);
};

//------------------------------------------------------------------------------
bool TVTExternalObjectPointer::readFromStream(TVT_Net *pVT_Net, LoopbackStream *pStream)
{
    bool valid = (pStream->available());
    uint16_t i = 0, j = 0, nn = 0;
    uint8_t bb = 0;
...
void TVTExternalObjectPointer::getAID()
{
    ...
    for (i = 1; i < VT_AID_Nr; i++) {
        ...
        switch (i) {
        case 1:
            VTDefaultObjectRef = ww;
            break;
        case 2:
            VTExternalNameRef = ww;
            break;
        case 3:
            VTExternalObjectRef = ww;
            break;
        //list
        case 4:
...
void TVTExternalObjectPointer::setAID()
{
    ...
    VTAttrAID[2].typeAID = 1;
    VTAttrAID[2].nameAID = "VTExternalNameRef";
    VTAttrAID[2].valueAID = QString::number(VTExternalNameRef);
    VTAttrAID[3].numAID = 3;
    VTAttrAID[3].byteAID = 2;
    VTAttrAID[3].typeAID = 1;
    VTAttrAID[3].nameAID = "VTExternalObjectRef";
    VTAttrAID[3].valueAID = QString::number(VTExternalObjectRef);
    VT_AID_Nr = 4;
}
